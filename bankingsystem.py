#MINIPROJECT_ONLINE BANKING SYSTEM_USING FUNCTIONS
#DISPLAY
print("\t\t\t\t****************************")
...
def balance():
    bal=customer_data[user_name]["balance"]
...
def withdraw():
    try:
        ...
        if withdraw_amount >= bal:
            ...
            newbalance = bal
            customer_data[user_name]["balance"] = newbalance
            print(
...
def changepassword():
    ...
    if new_password1 == new_password2:
        customer_data[user_name]["password"] = new_password1
...
while True:
    ...
    if user_name in customer_data and customer_data[user_name]["password"]==pass_word:
